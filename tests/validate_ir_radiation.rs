...
fn get_simple_results(
    ...
    for index in 0..horizontal_ir.len(){
        ...
        let expected_v = gain / surface_area / emmisivity
            + SIGMA * (ts + 273.15).powi(4);
        ...
        weather.horizontal_infrared_radiation_intensity = Box::new(ScheduleConstant::new(horizontal_ir[index]));
        ...
        weather.diffuse_horizontal_radiation= Box::new(ScheduleConstant::new(diffuse_horizontal_rad[index]));
